...
# Source Files
SRC = map/map_parsing.c map/map_verif.c map/map_valid_path.c mlx/mlx_utlis.c mlx/mlx_events.c game/game_move.c utils/utlis.c utils/utils_struct.c so_long.c main.c 
OBJ = $(SRC:.c=.o)
