...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/31 12:40:14 by mcogne--          #+#    #+#             */
/*   Updated: 2024/10/31 14:30:31 by mcogne--         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define IMG_WALL_END		"./sprites/wall/wall_end.xpm"		// 8

# define IMG_WALL_TOP		"./sprites/wall/wall_top.xpm"		// 0
# define IMG_WALL_BOTTOM	"./sprites/wall/wall_bottom.xpm"	// 1
# define IMG_WALL_RIGHT		"./sprites/wall/wall_right.xpm"		// 2
# define IMG_WALL_LEFT		"./sprites/wall/wall_left.xpm"		// 3

# define IMG_WALL_TOP_L		"./sprites/wall/coner/wall_top-left.xpm"	// 4
# define IMG_WALL_TOP_R		"./sprites/wall/coner/wall_top-right.xpm"	// 5
# define IMG_WALL_BOT_L		"./sprites/wall/coner/wall_bottom-left.xpm" // 6
# define IMG_WALL_BOT_R		"./sprites/wall/coner/wall_bottom-right.xpm" //7
